...
import com.lmq.ui.DoctorChooseList_Activity;
...
public class TeamListActivity extends UI implements AdapterView.OnItemClickListener {
    ...
    public static  final int REQUESTCODE_SELECTEPERSON=1;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==RESULT_OK){
            if(requestCode==REQUESTCODE_SELECTEPERSON&&data!=null){
                //选择联系人
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title=itemType == ItemTypes.TEAMS.ADVANCED_TEAM ?"高级群" : "讨论组";
        setTitleAndAdd(title, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //点击+号
                ToastHelper.showToast(TeamListActivity.this,"创建群聊!");
                Intent it=new Intent(TeamListActivity.this, DoctorChooseList_Activity.class);
                startActivityForResult(it,REQUESTCODE_SELECTEPERSON);
            }
        });
